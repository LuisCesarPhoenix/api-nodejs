...
/*
Armazena o nome da nova coleção (para onde os dados serão inseridos) em uma constante.
O valor é carregado a partir da variável de ambiente MONGO_COLLECTION_NEW.
*/
  ...
  */
  ...
  try {
    ...
    */
    ...
    /*
		Cria uma conexão com o banco de dados novo.
    - MONGO_URI_NEW contém a URL de conexão.
    - useNewUrlParser: true -> garante a compatibilidade com a nova sintaxe de conexão do MongoDB.
    - useUnifiedTopology: true -> ativa o novo mecanismo de gerenciamento de conexões.
    */
...
/*
Exporta a função assíncrona migrateData para que possa ser utilizada em outros arquivos do projeto.
*/
