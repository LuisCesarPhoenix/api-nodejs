...
/*
Essa linha importa o módulo Express, um framework para Node.js usado para criar aplicações web e APIs de forma simples e eficiente.
...
{ getUsers, getUserById, createUser, updateUser, deleteUser, loginUser, authenticateToken } usa desestruturação, ou seja, estamos extraindo funções específicas do módulo userController.
*/
...
createUser recebe os dados no corpo da requisição (req.body) e os insere no banco de dados.
*/
...
updateUser recebe os novos dados no corpo da requisição (req.body) e atualiza o usuário no banco de dados.
*/
...
a) Recebe o e-mail e a senha no corpo da requisição (req.body).
