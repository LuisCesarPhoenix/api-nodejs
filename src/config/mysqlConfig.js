...
Objetivo: Gerenciar conexões temporárias com o MySQL, garantindo que a conexão seja aberta apenas quando necessário e fechada após a execução da consulta.
*/
